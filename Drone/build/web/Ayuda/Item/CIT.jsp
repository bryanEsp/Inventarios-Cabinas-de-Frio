                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-header">
                                <i class="icono izquierda fas fa-boxes" style="width: 50px;height: 0px; font-size: 30px;"></i><h3 class="titulo"> ¿Como Consultar Un Item? </h3>
                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                ...
                                <section class="caption">
                                    <label id="lb01" class="label" autofocus>Seleccioné la opción “Items” en el menú lateral izquierdo como lo señala la imagen </label>
                                </section>
                            </div>
                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                <!-- Nombre Categoria --> 
                                <div class="imagen">
                                    <img src="${pageContext.request.contextPath}/img/CI(1).PNG">
                                </div> 
                                <section class="caption">
                                    <label id="lb01" class="label" autofocus>Se desplegaran dos opciones relacionadas con el Item seleccione la opción “Consultar Item” como lo señala la imagen.</label>
                                </section>
                            </div>
                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                <!-- Nombre Categoria --> 
                                <div class="imagen">
                                    <img src="${pageContext.request.contextPath}/img/CI(2).PNG">
                                </div> 
                                <section class="caption">
                                    <label id="lb01" class="label" autofocus>Se desplegara una tabla que le permitira visualizar los Items excistentes .</label>
                                </section>
                            </div>
