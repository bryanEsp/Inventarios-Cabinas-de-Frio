                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-header">
                                <i class="icono izquierda far fa-building" style="width: 50px;height: 0px; font-size: 30px;"></i><h3 class="titulo"> ¿Como consultar una institución? </h3>
                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                ...
                                <section class="caption">
                                    <label id="lb01" class="label" autofocus>Seleccioné la opción “Institucion” en el menú superior como lo señala la imagen </label>
                                </section>
                            </div>
                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                <!-- Nombre Categoria --> 
                                <div class="imagen">
                                    <img src="${pageContext.request.contextPath}/img/I(1).PNG">
                                </div> 
                                <section class="caption">
                                    <label id="lb01" class="label" autofocus>Se desplegaran dos opciones relacionadas con la Institucion seleccione la opción “Consultar Institucion” como lo señala la imagen.</label>
                                </section>
                            </div>
                    ...
                    <div class="modal-style"  role="document">
                        ...
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                <!-- Nombre Categoria --> 
                                <div class="imagen">
                                    <img src="${pageContext.request.contextPath}/img/I(2).PNG">
                                </div> 
                                <section class="caption">
                                    <label id="lb01" class="label" autofocus>Se desplegara una tabla que le permitira visualizar las Instituciones excistentes .</label>
                                </section>
                            </div>
